...
{
	// tmp
	defaultDirLight.ambient = vec3(0.7f,0.7f,0.7f);
	defaultDirLight.diffuse = vec3(0.9f,0.9f,0.9f);
	defaultDirLight.specular = vec3(0.0f,0.0f,0.0f);
	defaultDirLight.direction = vec3(0.0f,-1.0f,0.0f);
	// /tmp
	...
	result += CalcDirLight(defaultDirLight, norm, viewDir);
